    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAvatarMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAvatarMedias_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostSaves", x => new { x.SavedByUsersId, x.SavedPostsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostSaves_Users_SavedByUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowRequests_RequesterId_ReceiverId",
                table: "FollowRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAvatarMedias_UserId",
                table: "UserAvatarMedias",
                column: "UserId",
                unique: true);
